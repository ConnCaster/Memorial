...
set_target_properties(mongoc::shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmongoc2.so.2.0.0"
  IMPORTED_SONAME_RELEASE "libmongoc2.so.2"
  )

list(APPEND _cmake_import_check_targets mongoc::shared )
list(APPEND _cmake_import_check_files_for_mongoc::shared "${_IMPORT_PREFIX}/lib/libmongoc2.so.2.0.0" )
